...
public class AverPTZCommunicatorTest {
	...
	public void testDoneReadingWithOnlyException() throws Exception {
		...
		exceptionRule.expectMessage("Error response received from: ***REMOVED***. Request: 01,00,00,06,00,00,00,04,81,01,04,08,02,FF; response: 01,11,00,04,00,00,00,04,90,60,41,FF");
